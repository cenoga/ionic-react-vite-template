...
function buildHTMLStyles(state, latestValues, projection, layoutState, options, transformTemplate, buildProjectionTransform, buildProjectionTransformOrigin) {
    ...
    for (var key in latestValues) {
        ...
        if (isTransformProp(key)) {
             ...
             */
            if ((projection === null || projection === void 0 ? void 0 : projection.isHydrated.x) &&
                (projection === null || projection === void 0 ? void 0 : projection.isHydrated.y) &&
...
function snapshotViewportBox(visualElement, rebase) {
    ...
    visualElement.snapshot = {
        taken: sync.getFrameData().timestamp,
        transform: tslib.__assign({}, visualElement.getLatestValues()),
        ...
        var onSessionStart = function (event) {
            ...
            _this.cancelLayout = batchLayout(function (read, write) {
                ...
                read(function () {
                    ...
                    if (!isRelativeDrag && !_this.isExternalDrag()) {
                        _this.visualElement.rebaseProjectionTarget(true, _this.visualElement.measureViewportBox(false), false);
                    }
        ...
        _this.animate = function (target, origin, _a) {
            ...
            if (projectionParent) {
                ...
                if (projectionParent.isProjectionReady()) {
                     ...
                     */
                    if (!parentSnapshot ||
                        parentSnapshot.taken !== sync.getFrameData().timestamp) {
                        parentSnapshot = {
                            taken: 0,
        ...
        flush: function (_a) {
            ...
            batchLayout(function (read, write) {
                ...
                if (parent) {
                    ...
                    order.forEach(function (element) { return ancestors.push.apply(ancestors, tslib.__spreadArray([], tslib.__read(element.path))); });
...
var zeroProjection = createProjectionState();
var visualElement = function (_a) {
    ...
    return function (_a, options) {
        ...
        function triggerBuild() {
            ...
            build(element, renderState, valuesToRender, props._suppressProjection ? zeroProjection : leadProjection, layoutState, options, props);
        }
        function update() {
            lifecycles.notifyUpdate(latestValues);
        }
        function updateLayoutProjection() {
            if (!element.isProjectionReady() || props._suppressProjection)
                return;
        ...
        var element = tslib.__assign(tslib.__assign({ treeType: treeType, 
             ...
             */
            syncRender: function (suspendCrossfade) {
                var prevCrossfader = crossfader;
                if (suspendCrossfade)
                    crossfader = undefined;
                render();
                if (suspendCrossfade)
                    crossfader = prevCrossfader;
            }, 
            /**
            ...
            notifyLayoutReady: function (config) {
                ...
                element.notifyLayoutUpdate(layoutState.layout, element.snapshot
                    ? element.snapshot.viewportBox
                    : layoutState.layout, config);
            }, 
            /**
             * Temporarily reset the transform of the instance.
             */
            resetTransform: function () {
                return resetTransform(element, instance, props, renderState, options);
            }, restoreTransform: function () { return restoreTransform(instance, renderState); }, updateLayoutProjection: updateLayoutProjection,
...
var htmlConfig = {
    ...
    restoreTransform: function (domElement, renderState) {
        domElement.style.transform = renderState.style.transform;
    },
    ...
    build: function (element, renderState, latestValues, projection, layoutState, options, props) {
        ...
        var isProjectionTranform = element.isProjectionReady();
...
function layoutStack() {
    ...
    function getFollowViewportBox() {
        var _a;
        return state.follow
            ? (_a = state.follow.snapshot) === null || _a === void 0 ? void 0 : _a.viewportBox
            : snapshot === null || snapshot === void 0 ? void 0 : snapshot.viewportBox;
    }
...
var AnimateSharedLayout = /** @class */ (function (_super) {
    ...
    AnimateSharedLayout.prototype.startLayoutAnimation = function () {
        ...
        var handler = {
            ...
            parent: getNearestProjectionParent(this.context),
        };
        /**
    ...
    AnimateSharedLayout.prototype.scheduleUpdate = function (force) {
         ...
         */
        this.children.forEach(function (child) { return snapshotViewportBox(child); });
        /**
...
function getNearestProjectionParent(_a) {
    var visualElement = _a.visualElement;
    if (visualElement) {
