 ...
 */
export declare function snapshotViewportBox(visualElement: VisualElement, rebase?: boolean): void;
...
declare interface VisualElementConfig<Instance, RenderState, Options> {
    ...
    resetTransform(element: VisualElement<Instance>, instance: Instance, props: MotionProps, renderState: RenderState, options: Options): void;
